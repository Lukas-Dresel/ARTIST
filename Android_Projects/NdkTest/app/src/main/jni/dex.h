...
bool dex_FindVirtualMethod(const struct DexClass *class, struct DexMethod *result,
                           const char *descriptor, const char *signature);

bool dex_FindDirectMethod(const struct DexClass *class, struct DexMethod *result,
                          const char *descriptor, const char *signature);
