...
#ifndef NDKTEST_ART_ENTRYPOINTS_QUICK_ENTRYPOINTS_LIST_H
#define NDKTEST_ART_ENTRYPOINTS_QUICK_ENTRYPOINTS_LIST_H

/*
 * Original version before replacing stuff with void*
 *
...
#define QUICK_ENTRYPOINT_LIST(V) \
  ...
  V(AllocStringFromString, void*, void*) \
\
  V(InstanceofNonTrivial, uint32_t, const void*, const void*) \
  V(CheckCast, void, const void*, const void*) \
\
  V(InitializeStaticStorage, void*, uint32_t) \
  V(InitializeTypeAndVerifyAccess, void*, uint32_t) \
  V(InitializeType, void*, uint32_t) \
...
\
  ...
  V(GetObjStatic, void*, uint32_t) \
\
  V(AputObjectWithNullAndBoundCheck, void, void*, int32_t, void*) \
  V(AputObjectWithBoundCheck, void, void*, int32_t, void*) \
  V(AputObject, void, void*, int32_t, void*) \
  V(HandleFillArrayData, void, void*, void*) \
\
  V(JniMethodStart, uint32_t, struct Thread*) \
  V(JniMethodStartSynchronized, uint32_t, jobject, struct Thread*) \
  V(JniMethodEnd, void, uint32_t, struct Thread*) \
  V(JniMethodEndSynchronized, void, uint32_t, jobject, struct Thread*) \
  V(JniMethodEndWithReference, void*, jobject, uint32_t, struct Thread*) \
  V(JniMethodEndWithReferenceSynchronized, void*, jobject, uint32_t, jobject, struct Thread*) \
  V(QuickGenericJniTrampoline, void, void*) \
\
...
\
  ...
  V(Memcpy, void*, void*, const void*, size_t) \
\
  V(QuickImtConflictTrampoline, void, void*) \
  V(QuickResolutionTrampoline, void, void*) \
  V(QuickToInterpreterBridge, void, void*) \
  V(InvokeDirectTrampolineWithAccessCheck, void, uint32_t, void*) \
  V(InvokeInterfaceTrampolineWithAccessCheck, void, uint32_t, void*) \
  V(InvokeStaticTrampolineWithAccessCheck, void, uint32_t, void*) \
  V(InvokeSuperTrampolineWithAccessCheck, void, uint32_t, void*) \
...
\
  ...
  V(NewStringFromStringBuilder, void) \
\
  V(ReadBarrierJni, void, void*, void*)

#endif //NDKTEST_ART_ENTRYPOINTS_QUICK_ENTRYPOINTS_LIST_H
