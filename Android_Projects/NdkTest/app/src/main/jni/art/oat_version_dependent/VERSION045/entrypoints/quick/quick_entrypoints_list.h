...
\
  ...
  V(JniMethodStartSynchronized, uint32_t, jobject to_lock, struct Thread* self) \
  V(JniMethodEnd, void, uint32_t cookie, struct Thread* self) \
  V(JniMethodEndSynchronized, void, uint32_t cookie, jobject locked, struct Thread* self) \
  V(JniMethodEndWithReference, void*, jobject result, uint32_t cookie, struct Thread* self) \
  V(JniMethodEndWithReferenceSynchronized, void*, jobject result, uint32_t cookie, jobject locked, struct Thread* self) \
