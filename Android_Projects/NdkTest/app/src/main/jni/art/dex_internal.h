...
const char*                     GetFieldIDName(const struct DexHeader* hdr, const struct FieldID* method_id);
...
const struct StringID *         FindStringIDByModifiedUTF8StringValue(const struct DexHeader *hdr, const char *mutf8_string);
